...
//        return getString(sContext.getString(R.string.submit_pro_alg), "0");
//    }

//    public static void saveFilterSize(String value) {
//        saveString(sContext.getString(R.string.submit_pro_alg), value);
//    }

    public static String getFilterTime() {
        return getString(sContext.getString(R.string.submit_job_alg), "0");
    }

//    public static void saveFilterTime(String value) {
//        saveString(sContext.getString(R.string.submit_job_alg), value);
//    }
